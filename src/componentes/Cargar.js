                    ...
                    <div className="flex flex-col  bg-white rounded-b-md ">
                        <div className="flex justify-center text-sm text-gray-700">
                            <div className="mb-4">
                                ...
                                {/*    <ProgressButton state={botonCargando} onClick={handleEnviandoCarga}*/}
                                {/*                    controlled={botonCargandoControl} className="pb-container">*/}
                                {/*        Cargar*/}
                                {/*    </ProgressButton>*/}
                                {/*</div>*/}
                                ...
                                <div className="bg-white p-6 shadow-lg rounded-lg flex justify-end items-center">
                                    <label
                                        ...
                                        <span className="mt-2 text-base leading-normal">agregar</span>
                                        <button state={botonCargando} onClick={handleEnviandoCarga}
                                                controlled={botonCargandoControl} className="bg-rosa hover:opacity-75 text-white rounded-full px-8 py-2 w-52">
